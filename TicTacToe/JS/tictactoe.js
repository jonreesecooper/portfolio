...
function placeXorO(squareNumber) {
    ...
    //The some()l method is used to check each element of selectedSquare array to see if it contains the square number clicked on.
    ...
    function computersTurn() {
        ...
        while(!success){
            ...
            //If the random number evalues return true, the square hasn't been selected yet.
...
//This function takes a string paramenter of the path you set earlier for 
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    //This line idicates where the start of a lines x axis is.
    let x1 = coordX1,
